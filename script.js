...
const API_KEY = "3c30386ce306b1ca115ac7368b77572e"; // API key for OpenWeatherMap API

// Function to map weather descriptions to custom images
const getWeatherImage = (description) => {
    description = description.toLowerCase();
    if (description.includes("clear")) return "sunnyyy.png";
    if (description.includes("clouds")) return "cloudy.png";
    if (description.includes("rain")) return "rainy.png";
    if (description.includes("snow")) return "snowyyy.png";
    if (description.includes("thunderstorm")) return "thunderbolt.jpg";
    if (description.includes("drizzle")) return "dizzle.jpg";
